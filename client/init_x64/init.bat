...
copy C:\"Program Files (x86)"\GitDns\client\client_ungit_x86\client_ungit.bat %HOMEDRIVE%%HOMEPATH%\AppData\Roaming\Microsoft\Windows\"Start Menu"\Programs\Startup

copy C:\"Program Files (x86)"\GitDns\client\client_ungit_x86\clone.sh %HOMEDRIVE%%HOMEPATH%
